...
function TrainerReports() {
  return (
    <div>
      <PageHeader title="Reports" description="Performance, retention and revenue insights." />
          ...
          <div className="mt-4 h-72">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={attendanceTrend} margin={{ top: 5, right: 10, left: -20, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey="visits" stroke="var(--color-primary)" strokeWidth={2} fill="url(#rep1)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
